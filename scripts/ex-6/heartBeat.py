...
def topology():
    ...
    net.mobility(sta1, 'start', time=1, position='85,100,0')
    net.mobility(sta2, 'start', time=1, position='78,107,0')
    net.mobility(sta3, 'start', time=1, position='78,93,0')
    net.mobility(sta1, 'stop', time=250, position='85,100,0')
    net.mobility(sta2, 'stop', time=250, position='78,107,0')
    net.mobility(sta3, 'stop', time=250, position='78,93,0')
